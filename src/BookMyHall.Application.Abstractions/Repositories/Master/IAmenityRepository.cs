...
public interface IAmenityRepository
{
    ...
    Task<Amenity?> GetByNameIncludingDeletedAsync(string amenityName,CancellationToken cancellationToken = default);
    Task<Amenity?> GetByAmenityNameAsync(string amenityName, CancellationToken cancellationToken = default);
    Task<PaginatedResult<Amenity>> GetAllAsync(PaginationRequest request, CancellationToken cancellationToken = default);
