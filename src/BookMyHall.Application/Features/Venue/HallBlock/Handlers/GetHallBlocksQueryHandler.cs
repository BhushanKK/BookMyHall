...
public sealed class GetHallBlocksQueryHandler(IHallBlockRepository hallBlockRepository,IMapper mapper,
    ...
    : IRequestHandler<GetHallBlocksQuery,ApiResponse<PaginatedResponse<HallBlockDto>>>
{
    public async Task<ApiResponse<PaginatedResponse<HallBlockDto>>>Handle(GetHallBlocksQuery request,CancellationToken cancellationToken)
    {
        ...
        var cacheKey =HallBlockCacheKeyBuilder.BuildPaginatedKey(
                hallId,
        ...
        {
            return ApiResponse<PaginatedResponse<HallBlockDto>>.SuccessResponse(cachedResponse,
        ...
        // =====================================================
        var pagedResult =await hallBlockRepository.GetAllAsync(pagination,hallId,cancellationToken);
        // =====================================================
        // MAP RESULT
        // =====================================================
        ...
        var response =new PaginatedResponse<HallBlockDto>
            {
                Items =mapper.Map<IReadOnlyList<HallBlockDto>>(pagedResult.Items),
