...
{
    public async Task<ApiResponse<UserPreference>> Handle(
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return ApiResponse<UserPreference>.FailureResponse(
        ...
        return ApiResponse<UserPreference>.SuccessResponse(
            mapper.Map<UserPreference>(userPreference),
