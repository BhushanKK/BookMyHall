    ...
    : IRequestHandler<GetUserDetailsByIdQuery,ApiResponse<UserDetailsView>>
{
    ...
    {
        var userDetails =await userRepository.GetUserDetailsByIdAsync(request.userId,request.roleId,cancellationToken);
        ...
        return ApiResponse<UserDetailsView>.SuccessResponse(userDetails,
