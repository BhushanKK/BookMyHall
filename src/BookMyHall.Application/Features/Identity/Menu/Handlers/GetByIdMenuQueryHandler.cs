...
public sealed class GetByIdMenuQueryHandler(IMenuRepository menuRepository,IMapper mapper,
    IMessageHelper messageHelper,ICacheService cacheService)
    : IRequestHandler<GetByIdMenuQuery, ApiResponse<Menu>>
{
    public async Task<ApiResponse<Menu>> Handle(GetByIdMenuQuery request, CancellationToken cancellationToken)
    {
