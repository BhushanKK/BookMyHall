...
public sealed class PasswordResetCompletedEventHandler(
    IEmailTemplateService emailTemplateService,
    IEmailSender emailSender,
    IWebHostEnvironment environment)
    : INotificationHandler<PasswordResetCompletedEvent>
{
    public async Task Handle(PasswordResetCompletedEvent notification,
