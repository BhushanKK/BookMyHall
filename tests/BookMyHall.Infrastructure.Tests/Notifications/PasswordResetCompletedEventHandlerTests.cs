...
public sealed class PasswordResetCompletedEventHandlerTests : IDisposable
{
    ...
    public PasswordResetCompletedEventHandlerTests()
    {
        _webRootPath = Path.Combine(
            Path.GetTempPath(),
            $"PasswordResetCompletedTests_{Guid.NewGuid():N}");
    ...
    {
        // Arrange
        const string renderedHtml = "<html><body>Your password has been reset.</body></html>";
    ...
    public async Task Handle_ShouldRenderTemplateWithExpectedValues()
    {
        ...
        _templateServiceMock
            ...
            .ReturnsAsync("<p>Password reset completed.</p>");
        ...
        // Assert
        var model = Assert.IsType<Dictionary<string, string>>(
            templateModel);
    ...
    {
        // Arrange
        const string renderedHtml = "<p>Your password reset was completed.</p>";
        ...
        Assert.Equal("Your BookMyHall password has been reset successfully", email.Subject);
    ...
    public async Task Handle_WhenLogoDoesNotExist_ShouldThrowFileNotFoundException()
    {
        ...
        var sut = new PasswordResetCompletedEventHandler(
    ...
    private PasswordResetCompletedEventHandler CreateSut()
    {
        return new PasswordResetCompletedEventHandler(
            _templateServiceMock.Object,
            _emailSenderMock.Object,
            _environmentMock.Object);
    }

    private static PasswordResetCompletedEvent CreateNotification()
    {
        return new PasswordResetCompletedEvent(Guid.NewGuid(), UserName, Email);
    }
